...
namespace Indigo
{
    public class _getapiIndigo
    {
        ...
        #region GetseatAvailability
        public async Task<GetSeatAvailabilityResponse> GetseatAvailability(GetSeatAvailabilityRequest _getseatAvailabilityRequest, int a, int i)
        {
            IBookingManager bookingManager = null;
            GetSeatAvailabilityResponse _getSeatAvailabilityResponse = null;
            bookingManager = new BookingManagerClient();
            try
            {
                ...
                _getSeatAvailabilityResponse.SeatAvailabilityResponse.OtherServiceInfoList = OtherServiceInfoList;
                return _getSeatAvailabilityResponse;
            }
            catch (Exception ex)
            {
