            ...
            for (int p = 0; p < fareKey.Count; p++)
            {
                ...
                using (HttpClient client = new HttpClient())
                {
                    ...
                    if (_JourneykeyRTData.ToLower() == "vistara" || _JourneykeyRTData.ToLower() == "airindia" || _JourneykeyRTData.ToLower() == "hehnair")
                    {
                        ...
                        string res = _objAvail.AirPriceGetRoundTrip(AppUrlConstant.GDSURL, fareRepriceReq, availibiltyRQGDS, newGuid.ToString(), _targetBranch, _userName, _password, Airfaredata, farebasisdata, p, "");
